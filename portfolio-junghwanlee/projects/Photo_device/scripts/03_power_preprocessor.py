...
# Rule-based filtering bounds for instant power consumption
POWER_LOWER = 0
POWER_UPPER = 600
...
def preprocessor(feasible_consumption=False, split_running_status=False):
    _refined = pd.read_csv(
        DATA_PATH / "Final_plus_consumption_data_0116.csv",
        header=0,
        index_col=0,
        low_memory=False,
    )
...
if __name__ == "__main__":
    ...
    f.savefig(FIGURE_PATH / "0117_whole2_ex2.png", dpi=300)
